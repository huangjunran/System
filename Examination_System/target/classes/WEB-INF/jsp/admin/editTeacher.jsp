			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 style="text-align: center;">修改指导老师信息</h1>
						</div>
				    </div>
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/admin/editTeacher" id="editfrom" method="post">
							  <div class="form-group">
							    <label for="inputUserid" class="col-sm-2 control-label">工号</label>
							    <div class="col-sm-10">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputname" name="username" placeholder="请输入姓名" value="${teacher.username}">
							    </div>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
									<input type="text" class="form-control" id="inputmail" name="mail" placeholder="请输入邮箱" value="${teacher.mail}">
								</div>
							  </div>
							  <div class="form-group">
								<label for="inputphone" class="col-sm-2 control-label">电话</label>
								  <div class="col-sm-10">
								    <input type="text" class="form-control" id="inputphone" name="phone" placeholder="请输入联系方式" value="${teacher.phone}">
							  </div>
							  </div>
							<div class="form-group">
							  ...
							  <div class="form-group">
							    <label for="inputCount" class="col-sm-2 control-label" >开题总数</label>
							    <div class="col-sm-10">
									<input type="text" class="form-control" id="inputCount" name="titleCount" placeholder="请输入姓名" value="${teacher.titleCount}">
							    </div>
							  </div>
							  <div class="form-group">
							    <label  class="col-sm-2 control-label" name="grade">所属专业</label>
							    <div class="col-sm-10">
