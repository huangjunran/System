				...
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="/admin/editCourse" id="editfrom" method="post">
							  ...
							  <div class="form-group">
								  <label readonly="readonly" for="inputPassword3" class="col-sm-2 control-label" name="grade">指导老师</label>
								  <div class="col-sm-10">
							...
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label" name="grade">选课学生编号</label>
								<div class="col-sm-10">
									<%--<select class="form-control" name="studentid">--%>
										...
										<%--</c:forEach>--%>
									<%--</select>--%>
										<input type="number" class="form-control" id="studentid" name="studentid" placeholder="请输入学生编号" value="${course.studentid}">
